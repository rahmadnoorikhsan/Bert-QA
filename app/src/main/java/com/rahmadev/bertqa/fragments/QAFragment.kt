package com.rahmadev.bertqa.fragments
...
import com.rahmadev.bertqa.BertQAHelper
import com.rahmadev.bertqa.DataSetClient
import com.rahmadev.bertqa.R
import com.rahmadev.bertqa.adapters.ChatHistoryAdapter
import com.rahmadev.bertqa.adapters.QuestionSuggestionsAdapter
import com.rahmadev.bertqa.databinding.FragmentQABinding
import com.rahmadev.bertqa.models.Message
...
class QAFragment : Fragment() {
    ...
    private val args by navArgs<QAFragmentArgs>()
    ...
    private fun initBertQAModel() {
        bertQAHelper = BertQAHelper(requireContext(), object : BertQAHelper.ResultAnswerListener{
            ...
            override fun onResult(results: List<QaAnswer>?, inferenceTimeLong: Long) {
                results?.first()?.let {
